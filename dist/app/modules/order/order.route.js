...
router.put("/update-status/:orderId", order_controller_1.OrderController.updateOrderStatus); // Update Order Status
...
router.get("/order-status-counts/:sellerId", order_controller_1.OrderController.getOrderStatusCountsBySellerController);
...
router.get("/seller/statistics/:sellerId", order_controller_1.OrderController.getSellerStatisticsController);
// Seller order statistic
router.get("/seller-statistics/:sellerId", order_controller_1.OrderController.getSellerOrderStatisticsController);
